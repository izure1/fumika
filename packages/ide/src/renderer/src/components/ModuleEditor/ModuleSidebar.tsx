  ...
  return (
    <div className="w-56 bg-[#141414] border-r border-surface-800 flex flex-col overflow-hidden select-none">
      ...
      <div className="px-3 py-2 border-b border-surface-800 shrink-0">
        ...
        <input
          className="mt-1.5 w-full bg-surface-900/50 border border-surface-700 rounded px-2 py-1 text-[11px] text-white placeholder-surface-500 outline-none focus:border-primary-500/50"
